...
NameLb = Label(root, text="AGE OF PATIENT", fg="yellow", bg="black")
NameLb.grid(row=8, column=0, pady=25, sticky=W)

S1Lb = Label(root, text="SYMPTOM 1", fg="yellow", bg="black")
S1Lb.grid(row=9, column=0, pady=15, sticky=W)

S2Lb = Label(root, text="SYMPTOM 2", fg="yellow", bg="black")
S2Lb.grid(row=10, column=0, pady=15, sticky=W)

S3Lb = Label(root, text="SYMPTOM 3", fg="yellow", bg="black")
S3Lb.grid(row=11, column=0, pady=15, sticky=W)

S4Lb = Label(root, text="SYMPTOM 4", fg="yellow", bg="black")
S4Lb.grid(row=12, column=0, pady=15, sticky=W)

S5Lb = Label(root, text="SYMPTOM 5", fg="yellow", bg="black")
S5Lb.grid(row=13, column=0, pady=15, sticky=W)


lrLb = Label(root, text="DECISIONTREE", fg="black", bg="crimson")
lrLb.grid(row=17, column=0, pady=20,sticky=W)

destreeLb = Label(root, text="RANDOMFOREST", fg="black", bg="crimson")
destreeLb.grid(row=19, column=0, pady=20, sticky=W)

ranfLb = Label(root, text="NAIVEBAYES", fg="black", bg="crimson")
ranfLb.grid(row=21, column=0, pady=20, sticky=W)
...
Age = Entry(root, textvariable=NUMERIC)
